...
class RentHouseAction extends AdminBaseAction {
	
	public function show(){
			$this->display(APP_PATH.'/Tpl/default/Admin/rentHouse/list.html');
	}
	...
	public function add(){
		...
		$this->display( APP_PATH.'/Tpl/default/Admin/rentHouse/add.html');
	}
	...
	function insert(){
		...
		$uploadPath = 'Public/Uploads/rent/'.date("Ymd").'/';
	...
	function edit(){
		...
		Load('extend');//加载扩展函数库
		$this->display( APP_PATH.'/Tpl/default/Admin/rentHouse/edit.html');
	}
